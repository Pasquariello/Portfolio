                ...
                links.map(link => {
                    return (
                        ...
                        >
                            ...
                            <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-teal-900/35 bg-teal-500 hover:cursor-pointer hover:animate-pulse">
