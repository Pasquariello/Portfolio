      ...
      <div className='flex align-center h-screen items-center'>
        <div className='lg:pl-24 w-full'>
            <div className='flex flex-col lg:items-center text-center lg:inline-block' >
              <h2 className={`${roboto.className} text-white text-xl sm:text-4xl font-light relative`}>Welcome to my profile!</h2>
              <h1 className={`${titillium.className} text-white text-5xl sm:text-8xl mt-4 mb-8`}>Taylor Pasquariello</h1>
              <h2 className={`${roboto.className} text-white text-xl sm:text-4xl font-light relative`}><TextLoop/></h2>
            </div>
        </div>
